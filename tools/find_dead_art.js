...
const PROVIDERS = ['js/art.js', 'js/actors.js', 'js/ambience.js', 'js/painted-cast.js', 'js/icons.js', 'js/cutscenes.js'];
const CONSUMERS = [
    'js/art.js', 'js/actors.js', 'js/ambience.js', 'js/painted-cast.js', 'js/icons.js', 'js/cutscenes.js',
