...
// The shared modules expose their helpers as script-scope declarations rather
// than objects, so room modules can call them unqualified. Derive the list from
// the files themselves instead of hand-maintaining a copy that will drift.
...
const SHARED_ART_MODULES = ['js/art.js', 'js/actors.js', 'js/ambience.js', 'js/painted-cast.js', 'js/icons.js', 'js/cutscenes.js'];
...
module.exports = [
    ...
    },
    {
        ...
        files: ['js/art.js', 'js/actors.js', 'js/ambience.js', 'js/painted-cast.js', 'js/icons.js', 'js/cutscenes.js', 'js/game.js', 'js/rooms/**/*.js'],
        languageOptions: {
            ecmaVersion: 2022,
            sourceType: 'script',
